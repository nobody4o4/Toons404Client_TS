...
function NotFound() {
  return (
    <section className="flex min-h-screen bg-white dark:bg-gray-900 md:p-24 lg:p-32">
      <div className="mx-auto px-6 py-12  sm:flex-row-reverse md:flex-row lg:flex lg:items-center lg:gap-12">
