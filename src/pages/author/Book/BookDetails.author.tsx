...
import ChapterCardAuthor from "@/components/Author/Book/chapterCard.author";
      ...
      <div className="px-4">
        <div className="flex  items-center justify-between space-x-4 pb-8">
          ...
          <Link
            ...
            to={`/dashboard/author/edit/book/${bookId}`}
          >
