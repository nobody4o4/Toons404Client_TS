...
// import { TMailParameter } from "@/types/common.types";
// import EditorJS, { ToolConstructable } from "@editorjs/editorjs";
// import { useCallback, useEffect, useMemo, useRef, useState } from "react";
// import { UseFormRegisterReturn } from "react-hook-form";
// import { InputFieldWrapper } from "./input-field";

// interface IProps {
//   name: string;
//   label?: string;
//   placeholder?: string;
//   get: UseFormRegisterReturn;
//   allow?: {
//     header?: boolean;
//     linkTool?: boolean;
//     list?: boolean;
...
//   defaultValue?: any;
//   current?: string;
//   clearCurrent?: React.Dispatch<React.SetStateAction<string | undefined>>;
//   allParameters?: TMailParameter[];
// }
...
//     return {
//       header: allow?.header ?? true,
//       linkTool: allow?.linkTool ?? true,
//       list: allow?.list ?? true,
//       code: allow?.code ?? true,
//       inlineCode: allow?.inlineCode ?? true,
//       table: allow?.table ?? true,
//       embed: allow?.embed ?? true,
//       raw: allow?.raw ?? true,
//       image: allow?.image ?? true,
//     };
//   }, [allow]);
...
//             : "",
//         tools: {
//           ...(modules.header && { header: Header }),
//           ...(modules.linkTool && { linkTool: LinkTool }),
//           ...(modules.list && { list: List }),
//           ...(modules.code && { code: Code }),
//           ...(modules.inlineCode && { inlineCode: InlineCode }),
//           ...(modules.table && { table: Table }),
//           ...(modules.embed && { embed: Embed }),
//           ...(modules.raw && { raw: RawTool }),
//           ...(modules.image && {
//             image: {
//               class: Image,
//               config: {
...
//       });
//     }
//   }, [placeholder, modules, defaultValue, name]);
